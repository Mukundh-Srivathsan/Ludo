...
public class RedCoins extends View {
    ...
    public RedCoins(Context context) {
        super(context);

        init(null);
    }

    public RedCoins(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);

        init(attrs);
    }

    public RedCoins(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        init(attrs);
    }

    public RedCoins(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
