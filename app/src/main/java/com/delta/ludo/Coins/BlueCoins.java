...
public class BlueCoins extends View {
    ...
    public BlueCoins(Context context) {
        super(context);

        init(null);
    }

    public BlueCoins(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);

        init(attrs);
    }

    public BlueCoins(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        init(attrs);
    }

    public BlueCoins(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        coin1 = new Circle(275, getHeight() / 2 + 175);
        coin2 = new Circle(375, getHeight() / 2 + 175);
        coin3 = new Circle(275, getHeight() / 2 + 275);
        coin4 = new Circle(375, getHeight() / 2 + 275);
