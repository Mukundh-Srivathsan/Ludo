...
public class YellowCoins extends View {
    ...
    public YellowCoins(Context context) {
        super(context);

        init(null);
    }

    public YellowCoins(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);

        init(attrs);
    }

    public YellowCoins(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        init(attrs);
    }

    public YellowCoins(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
